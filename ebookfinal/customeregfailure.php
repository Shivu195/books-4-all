...
.details{
	...
	.details textarea {  width: 325px; height:70px; border-radius:5px; }
	.details select {  width: 250px; height:30px; border-radius:5px; }
	.login{
	padding:10px;
	color:black;
...
<center>
<h1 class="heading">FAILURE</h1>
<h3 class="please">Sorry, you have not been registered...Please try later.</h3></center>
<a href="index.php"><div class="login">Registration</div></a></br>
