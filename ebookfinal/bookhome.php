    ...
    <div id="content">
        ...
        <div id="content_right">
        	<div class="product_box">
            	<h1>Photography  <span>by XYZ</span></h1>
   	            <img src="images/image_01.jpg" alt="image" />
                <div class="product_info">
                    <p>Guide to taking the perfect photos...</p>
                    <h3>Rs.100</h3>
            ...
            <div class="product_box">
            	<h1>Scrumptious Vegetarian Salads  <span>by Sanjeev Kapoor</span></h1>
       	    <img src="images/image_02.jpg" alt="image" />
                <div class="product_info">
                	<p>make way for a range of salads that are taking centre stage!...</p>
                    <h3>Rs.50</h3>
                    <div class="buy_now_button"><a href="subpage.php">Buy Now</a></div>
                    <div class="detail_button"><a href="subpage.php">Detail</a></div>
                </div>
            ...
            <div class="product_box">
            	<h1>Gardening <span>by PQR</span></h1>
   	      <img src="images/image_03.jpg" alt="image" />
                <div class="product_info">
                	<p>Guide to maintaining a perfect garden!...</p>
                    <h3>Rs.70</h3>
                    <div class="buy_now_button"><a href="subpage.php">Buy Now</a></div>
                    <div class="detail_button"><a href="subpage.php">Detail</a></div>
                </div>
            ...
            <div class="product_box">
            	<h1>Sushi Book  <span>by LMN</span></h1>
            	<img src="images/image_04.jpg" alt="image" />
                <div class="product_info">
                	<p>Learn how to make the perfect Sushi in ...</p>
                    <h3>Rs.95</h3>
                    <div class="buy_now_button"><a href="subpage.php">Buy Now</a></div>
                    <div class="detail_button"><a href="subpage.php">Detail</a></div>
                </div>
        ...
        <div class="product_box">
                <h1>Programming <span>by XYZ</span></h1>
                <img src="images/image_07.jpg" alt="image" />
                <div class="product_info">
                    <p>concept of c programming...</p>
                    <h3>Rs.240</h3>
                    <div class="buy_now_button"><a href="subpage.php">Buy Now</a></div>
                    <div class="detail_button"><a href="subpage.php">Detail</a></div>
                </div>
        ...
        <div class="product_box">
                <h1>Inferno<span>by Dan Brown</span></h1>
                <img src="images/image_08.jpg" alt="image" />
                <div class="product_info">
                    <p>Suspence and thriller...</p>
                    <h3>Rs.220</h3>
                    <div class="buy_now_button"><a href="subpageaction.php">Buy Now</a></div>
                    <div class="detail_button"><a href="subpageaction.php">Detail</a></div>
                </div>
        </div>
             ...
             <div class="product_box">
                <h1>IIT book  <span>by HC verma</span></h1>
                <img src="images/image_05.jpg" alt="image" />
                <div class="product_info">
